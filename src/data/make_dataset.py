# Scripts to download or generate data# Scripts to download or generate data from PneumoniaMNIST
import pickle
import random
import sys
...
# train_labels is something like shape (N, 1); make it 1D
labels = train_labels.squeeze()      # or: labels = train_labels[:, 0]

import matplotlib
matplotlib.use("Agg")               # important on the cluster, no display
